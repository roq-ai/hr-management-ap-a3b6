  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application: Streamlining Human Resources for Businesses Everywhere. Experience Efficiency, Effectiveness, and Excellence in HR Operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application: Streamlining Human Resources for Businesses Everywhere. Experience Efficiency, Effectiveness, and Excellence in HR Operations.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Applicant" type="applicant" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
